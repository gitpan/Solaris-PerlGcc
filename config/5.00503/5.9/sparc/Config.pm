...
## Target system     : sunos localhost 5.9 sun4u sparc sunw,ultra-1
#
...
cat='cat'
cccdlflags='-fPIC'
ccdlflags='-R /usr/perl5/5.00503/lib/sun4-solaris/CORE'
ccsymbols='__GCC_NEW_VARARGS__=1 __SVR4=1 __sparc=1 cpu=sparc machine=sparc system=svr4 system=unix'
cf_by='perl-bugs'
...
cpp='cpp'
cpp_stuff='42'
cppccsymbols='__sparc__=1 __sun=1 __sun__=1 __svr4__=1 __unix=1 __unix__=1 sparc=1 sun=1 unix=1'
cpplast='-'
cppminus='-'
cpprun='gcc -E'
cppstdin='gcc -E'
...
myuname='sunos localhost 5.9 sun4u sparc sunw,ultra-1'
n=''
netdb_hlen_type='int'
